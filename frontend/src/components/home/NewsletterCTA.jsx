...
export default function NewsletterCTA() {
  ...
  style={{
    backgroundImage: "url('/header4.png')",
    opacity: 0.3,
  }}
/>
        ...
        <div className="relative z-10 max-w-2xl mx-auto flex flex-col items-center gap-4">
          <div className="inline-flex items-center gap-1 bg-white/10 backdrop-blur-xl border border-white/10 rounded-full px-3 py-1 text-[11px] font-bold tracking-widest uppercase text-pink-300">
            <Rocket size={12} /> APEXEDGE GAMING
          </div>
          ...
          <p className="text-slate-300 text-sm sm:text-base max-w-md leading-relaxed">
            Subscribe to receive the latest gaming news, esports updates,
            game reviews, hardware insights, gaming guides, and exclusive
            content from the ApexEdge Gaming team directly in your inbox.
          </p>

          <form
            onSubmit={(e) => e.preventDefault()}
            className="w-full max-w-md flex flex-col sm:flex-row gap-2 mt-4"
          >
            <input
              type="email"
              placeholder="Enter your email address"
              className="bg-slate-900/50 border border-slate-700 text-white rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-violet-500 focus:ring-1 focus:ring-violet-500 w-full placeholder:text-slate-500 font-medium transition-all"
            />
