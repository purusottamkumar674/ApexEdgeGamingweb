...
const HERO_SLIDES = [
  {
    ...
    title: 'Your Ultimate Destination for Gaming News, Reviews, Guides, and Esports Coverage',
    primaryCta: { label: 'Explore Gaming', to: '/blog' },
    secondaryCta: { label: 'About ApexEdge', to: '/about' },
  },
  {
    image: '/header1.png',
    label: 'APEXEDGE GAMING NEWS',
    title: 'Stay Updated with the Latest Gaming Releases, Industry Trends, and Community Stories',
    primaryCta: { label: 'Read Articles', to: '/blog' },
    secondaryCta: { label: 'Learn More', to: '/about' },
  },
  {
    image: '/header2.png',
    label: 'APEXEDGE GAMING COMMUNITY',
    title: 'Discover Expert Reviews, Pro Gaming Tips, Hardware Insights, and Esports Updates',
